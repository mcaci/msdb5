...
func TestScenarioWithAceOfCoinWinningIndex(t *testing.T) {
	...
	verifyIndexScenario(t, deck.Cards{1, 2, 3, 4, 5}, testSeeder(card.Coin), 0)
}

func TestScenarioWithThreeOfCoinWinningIndex(t *testing.T) {
	// 2 to 6 of Coin
	verifyIndexScenario(t, deck.Cards{2, 3, 4, 5, 6}, testSeeder(card.Coin), 1)
}

func TestScenarioWithEightOfCoinWinningIndex(t *testing.T) {
	// 4 to 8 of Coin
	verifyIndexScenario(t, deck.Cards{4, 5, 6, 7, 8}, testSeeder(card.Cup), 4)
}
...
func TestScenarioWithTwoOfSwordsWinningBecauseOfBriscolaIndex(t *testing.T) {
	...
	verifyIndexScenario(t, deck.Cards{34, 40, 3, 22, 15}, testSeeder(card.Sword), 3)
}

func TestScenarioWithTwoBriscolaCardsIndex(t *testing.T) {
	// 4 of Cudgel, 10 of Cudgel, 3 of Coin, 2 of Sword, 5 of Cup
	verifyIndexScenario(t, deck.Cards{34, 40, 3, 22, 15}, testSeeder(card.Cudgel), 1)
}
func TestScenarioWithTwoBriscolaCardsAndHighCardAtTheEndIndex(t *testing.T) {
	...
	verifyIndexScenario(t, deck.Cards{34, 40, 9, 22, 11}, testSeeder(card.Cudgel), 1)
}

func verifyIndexScenario(t *testing.T, cardsOnTheTable deck.Cards, briscola testSeeder, expectedWinner uint8) {
