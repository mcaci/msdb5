...
COPY ./ /go/src/github.com/nikiforosFreespirit/msdb5
...
RUN cd /go/src/github.com/nikiforosFreespirit/msdb5 && go get github.com/gorilla/websocket golang.org/x/text && go build
...
ENTRYPOINT "/go/src/github.com/nikiforosFreespirit/msdb5/msdb5"
